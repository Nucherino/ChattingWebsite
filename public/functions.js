...
function updateUserList(userList) {
    const userListHTML = document.getElementById("user-list");
    userListHTML.innerHTML = "";
    userList.forEach(user => {
        const listItem = document.createElement("li");
        listItem.textContent = user;
        userListHTML.appendChild(listItem);
    });
}
...
function sendChat() {
    ...
    chatTextBox.value = "";
    const xsrfToken = document.querySelector('input[name="xsrf_token"]').value;
    if (ws) {
        // Using WebSockets
